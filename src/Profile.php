...
class Profile extends CommonGLPI
{
    ...
    {
        return __('GLPI Cloud', 'glpicloud');
    }
    ...
    private static function rights(): array
    {
        return [
            [
                ...
                'label'    => __('Configuration', 'glpicloud'),
                'field'    => 'plugin_glpicloud_config',
            ],
            [
                'itemtype' => Account::class,
                'label'    => __('Cloud accounts', 'glpicloud'),
                'field'    => 'plugin_glpicloud_account',
            ],
            [
                'itemtype' => Resource::class,
                'label'    => __('Cloud resources', 'glpicloud'),
                'field'    => 'plugin_glpicloud_resource',
            ],
        ];
    }
